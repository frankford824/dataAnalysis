...
class TestClassifyChain:
    ...
    def test_rule_before_dictionary(self):
        ...
        major, _minor, excluded, _orderless, _via = resolve_class({"subject": "订单售后退款"}, rules, lookup)
    ...
    def test_dictionary_as_fallback(self):
        ...
        major, minor, _, _, _ = resolve_class({"subject": "软件服务费"}, rules, lookup)
    ...
    def test_unclassified_stays_unclassified(self):
        ...
        major, minor, excluded, _orderless, _via = resolve_class({"subject": "没见过的科目"}, rules, self._no_dict)
    ...
    def test_explicit_exclusion(self):
        ...
        _major, _minor, excluded, _orderless, _via = resolve_class({"subject": "账户互转"}, rules, self._no_dict)
        assert excluded
